...
\begin{center}
\vspace*{1em}\begin{tikzpicture}[scale=1.0,
    punkt/.style={circle, minimum size = 0.05cm,blue,fill=red},
]

\draw[help lines,yellow,thin] (0,0) grid (9,9);
...
\node  [below] (X) at (4.5,-0.5){X};
\node  [left] (Y) at (-0.5,4.5){Y};
...
\node  [below] (x8) at (8,0){8};
\node  [below] (x9) at (9,0){9};
...
\node  [left] (y6) at (0,6){6};
\node  [left] (y7) at (0,7){7};
\node  [left] (y8) at (0,8){8};
\node  [left] (y9) at (0,9){9};
...
1 & 1	&  1& -2.5	&	-2.3333	&	5.8333	&6.25		\\
2 & 2	&	3	&	-1.5	&	-0.3333	&	0.5	&	2.25	\\
3 & 3	&	2	&	-0.5	&	-1.3333	&	0.6666	&	0.25	\\
4 & 4	&	5	&	0.5	&	1.6666	&0.83333 	&	2.25	\\
5 & 5	&	4	&	1.5	&	0.6666	&1	&	2.25	\\  
6 & 6	&	5	&	2.5	&	1.6666	&	4.166666	&	6.25	\\  
\midrule
$\sum$ & 21 & 20 & & & 13 & 17.5 \\ \bottomrule
\end{tabular}
\end{center}

Mit Hilfe der Werte aus der Tabelle lassen sich \(a\) und \(b\) einfach bestimmen. Hinweis: \(\bar x = 21/6 = 3.5\), \(\bar y = 20/6 = 3.333\)

\[ a = \frac{\frac{\sum_{i=1}^n \left(x_i-\bar x \right)\left(y_i-\bar y \right)}{6}}{ 
\frac{\sum_{i=1}^6 \left( x_i - \bar x \right)^2}{6}} = \frac{\sum_{i=1}^n\left(x_i-\bar x \right)\left(y_i-\bar y \right)}{\sum_{i=1}^n \left(x_i-\bar x \right)^2}  = \frac{13}{17.5} = 0.742857143\]
...
\[ b = \bar y - a\cdot \bar x = 3,333333333
 - 0.742857143 \cdot 3.5 = 0.733333333
 \]
...
\draw[blue, very thick](0,0.7333)--(7,5.9333);
%\node[punkt] (A) at (9,1){};
%\node[draw] (B) at (8,4){B};
%\draw (A) -- (B);
\end{tikzpicture}
